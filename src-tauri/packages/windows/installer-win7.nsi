...
Function CheckWindowsVersion
    ...
    ${Else}
        ...
        DetailPrint "检测到 Windows 8+ 系统，无需安装 VxKex"
    ${EndIf}
FunctionEnd
...
Section Uninstall
  ...
  DetailPrint "VxKex 配置已移除（VxKex 程序未卸载）"
